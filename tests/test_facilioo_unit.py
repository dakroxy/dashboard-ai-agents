...
# ETag-Tests entfernt: Spike 2026-04-30 ergab kein Facilioo-ETag-Support.
# Code-Pfad in _api_get wurde im Code-Review (Decision 1, 2026-04-30) komplett
# entfernt — kein Dead-Code, kein doppelter API-Footprint.
